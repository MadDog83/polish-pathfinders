...
const EN: Dict = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: "What is the CUKR residence card for Ukrainian citizens?", a: "The CUKR residence card is a 3-year temporary residence permit for people with UKR status (based on temporary protection, not refugee status) who arrived in Poland after 23 February 2022. Applications are filed online in the MOS portal. The cost is PLN 340 stamp duty plus PLN 100 for the card. The current filing deadline — 4 March 2027 — is tied to the EU's temporary protection framework period, which has already been extended twice (most recently to 4 March 2028), so this date may change. Check gov.pl/UDSC for the current deadline closer to that date." },
...
const PL: Dict = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Czym jest karta pobytu CUKR dla obywateli Ukrainy?", a: "Karta pobytu CUKR to zezwolenie na pobyt czasowy na 3 lata dla osób ze statusem UKR (na podstawie ochrony czasowej, a nie statusu uchodźcy), które przyjechały do Polski po 23 lutego 2022. Wnioski składa się elektronicznie w portalu MOS. Koszt to 340 zł opłaty skarbowej plus 100 zł za kartę. Obecny termin składania wniosków — 4 marca 2027 — jest powiązany z unijnym okresem ochrony czasowej, który był już dwukrotnie przedłużany (ostatnio do 4 marca 2028), więc ta data może się zmienić. Sprawdzaj aktualny termin na gov.pl/UDSC bliżej daty." },
