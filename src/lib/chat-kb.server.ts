...
export function buildSystemPrompt(query = "", withSearch = true, locale?: string): string {
  return [
    ...
    "FEES: match every stamp-duty fee strictly to the correct permit type — never reuse one permit's fee for another. Zezwolenie na pobyt czasowy (temporary residence): 340 zł, or 440 zł only for the 'residence and work' basis. Zezwolenie na pobyt stały (permanent residence): always a flat 640 zł — never 340 or 440 zł. Zezwolenie na pobyt rezydenta długoterminowego UE (EU long-term resident): always a flat 640 zł. CUKR: 340 zł. All of the above are additionally plus 100 zł for the card itself (50 zł reduced fee for students, pupils, and children under 16). Before stating any fee number, double-check which permit type the question is actually about.",
