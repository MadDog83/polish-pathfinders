...
export function buildSystemPrompt(
  ...
  return [
    ...
    "",
    "CITE ONCE: when you cite a provision, emit the marker and nothing else — do not also write the act's name out in your own prose. The system prints the act name next to the article for you. Writing both produces 'art. 112a ust. 1 ustawy o cudzoziemcach ustawa o cudzoziemcach, art. 112a ust. 1', which looks broken.",
